            ...
            <div className="card-body row">
              ...
              <div className="col-lg-6 p-t-20">
                <div className="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                  ...
                  <label className="mdl-textfield__label">Joining Date</label>
                </div>
              </div>
              <div className="col-lg-6 p-t-20">
                <div className="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                  <input className="mdl-textfield__input" type="password" id="txtPwd" />
                  <label className="mdl-textfield__label">Password</label>
                </div>
              </div>
              <div className="col-lg-6 p-t-20">
                <div className="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                  <input className="mdl-textfield__input" type="password" id="txtConfirmPwd" />
              ...
              <div className="col-lg-6 p-t-20">
                <div className="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height txt-full-width">
                  <input className="mdl-textfield__input" type="text" id="list2" defaultValue readOnly tabIndex={-1} />
                  <label htmlFor="list2" className="pull-right margin-0">
                    <i className="mdl-icon-toggle__label material-icons">keyboard_arrow_down</i>
                  </label>
                  <label htmlFor="list2" className="mdl-textfield__label">Department</label>
                  <ul data-mdl-for="list2" className="mdl-menu mdl-menu--bottom-left mdl-js-menu">
                    <li className="mdl-menu__item" data-val="DE">Library</li>
                    <li className="mdl-menu__item" data-val="BY">Administration</li>
                    <li className="mdl-menu__item" data-val="BY">Transport</li>
                    <li className="mdl-menu__item" data-val="BY">Laboratory</li>
                  </ul>
                </div>
              </div>
              <div className="col-lg-6 p-t-20">
                <div className="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height txt-full-width">
                  <input className="mdl-textfield__input" type="text" id="sample2" defaultValue readOnly tabIndex={-1} />
                  <label htmlFor="sample2" className="pull-right margin-0">
                    <i className="mdl-icon-toggle__label material-icons">keyboard_arrow_down</i>
                  </label>
                  <label htmlFor="sample2" className="mdl-textfield__label">Gender</label>
              ...
              <div className="col-lg-6 p-t-20">
                <div className="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                  <input className="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="text5" />
                  <label className="mdl-textfield__label" htmlFor="text5">Mobile Number</label>
              ...
              <div className="col-lg-6 p-t-20">
                <div className="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                  ...
                  <label className="mdl-textfield__label">Birth Date</label>
                </div>
              </div>
              <div className="col-lg-12 p-t-20">
                <div className="mdl-textfield mdl-js-textfield txt-full-width">
                  <textarea className="mdl-textfield__input" rows={4} id="text7" defaultValue={""} />
                  <label className="mdl-textfield__label" htmlFor="text7">Address</label>
                </div>
              </div>
              <div className="col-lg-12 p-t-20">
                <label className="control-label col-md-3">Upload Photo
                </label>
              ...
              <div className="col-lg-12 p-t-20">
                <div className="mdl-textfield mdl-js-textfield txt-full-width">
                  <textarea className="mdl-textfield__input" rows={4} id="education" defaultValue={""} />
                  <label className="mdl-textfield__label" htmlFor="text7">Education</label>
                </div>
              </div>
